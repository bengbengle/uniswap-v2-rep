import { ChainId, Currency, currencyEquals, JSBI, Price, WETH } from '@benboba790111/uniswap-v2-sdk'
...
export default function useUSDCPrice(currency?: Currency): Price | undefined {
  ...
  const tokenPairs: [Currency | undefined, Currency | undefined][] = useMemo(
    () => [
      ...
      [wrapped?.equals(USDC) ? undefined : wrapped, chainId === ChainId.BSC_TESTNET ? USDC : undefined],
      [chainId ? WETH[chainId] : undefined, chainId === ChainId.BSC_TESTNET ? USDC : undefined]
    ],
