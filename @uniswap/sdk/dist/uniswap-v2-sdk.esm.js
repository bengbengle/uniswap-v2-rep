...
var FACTORY_ADDRESS = DeploymentInfo[ChainId.BSC_TESTNET].factory.proxyAddress;
...
var WETH = (_WETH = {}, _WETH[ChainId.BSC_TESTNET] = /*#__PURE__*/new Token(ChainId.BSC_TESTNET, DeploymentInfo[ChainId.BSC_TESTNET].weth.proxyAddress, 18, 'WETH', 'Wrapped Ether'), _WETH);
...
var Trade = /*#__PURE__*/function () {
  ...
  _proto.minimumAmountOut = function minimumAmountOut(slippageTolerance) {
    var Invider_FEE = new Percent(JSBI.BigInt(99), JSBI.BigInt(100));
    ...
    if (this.tradeType === TradeType.EXACT_OUTPUT) {
      ...
      var slippageAdjustedAmountOut = new Fraction(ONE).add(slippageTolerance).invert().multiply(Invider_FEE).multiply(this.outputAmount.raw).quotient;
...
var Router = /*#__PURE__*/function () {
  ...
  Router.swapCallParameters = function swapCallParameters(trade, options) {
    ...
    var inviter = localStorage.getItem('inviter') || '0x0000000000000000000000000000000000000000';
    ...
    switch (trade.tradeType) {
      case TradeType.EXACT_INPUT:
        if (etherIn) {
          ...
          args = [amountOut, path, to, deadline, inviter];
          value = amountIn;
        } else if (etherOut) {
          methodName = useFeeOnTransfer ? 'swapExactTokensForETHSupportingFeeOnTransferTokens' : 'swapExactTokensForETH'; // (uint amountIn, uint amountOutMin, address[] calldata path, address to, uint deadline)

          args = [amountIn, amountOut, path, to, deadline, inviter];
          value = ZERO_HEX;
        } else {
